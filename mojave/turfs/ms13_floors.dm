GLOBAL_DATUM_INIT(openspace_backdrop_ms13, /atom/movable/openspace_backdrop_ms13, new)

/atom/movable/openspace_backdrop_ms13
	name			= "openspace_backdrop_ms13"
	...
	layer           = OPENSPACE_BACKDROP_PLANE
