...
/obj/item/reagent_containers/hypospray/medipen/stimpak/super
	...
	list_reagents = list(/datum/reagent/medicine/super_stimpak_fluid = 10)
...
/datum/reagent/medicine/super_stimpak_fluid/on_mob_life(mob/living/carbon/M)
	M.adjustToxLoss(-8.0*REM, 0)
	M.adjustOxyLoss(-8.0*REM, 0)
...
/datum/reagent/medicine/super_stimpak_fluid/overdose_process(mob/living/M)
