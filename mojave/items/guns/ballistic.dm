...
/obj/item/gun/ballistic/automatic/fallout/minigun
	...
	fire_sound = 'mojave/sound/f13weapons/10mm_fire_03.ogg'
	fire_delay = 0.2
...
/obj/item/gun/ballistic/automatic/fallout/shotgun/pancor
	...
	fire_sound = 'mojave/sound/f13weapons/repeater_fire.ogg'
...
/obj/item/gun/ballistic/automatic/fallout/bozar
	...
	w_class = WEIGHT_CLASS_HUGE
	weapon_weight = WEAPON_HEAVY
	fire_sound = 'mojave/sound/f13weapons/bozar_fire.ogg'
	zoomable = TRUE
	zoom_amt = 10
	zoom_out_amt = 13
 ...
 /obj/item/gun/ballistic/automatic/fallout/m72
	...
	fire_sound = 'mojave/sound/f13weapons/gauss_rifle.ogg'
	can_suppress = FALSE
	fire_delay = 3
	zoomable = TRUE
	zoom_amt = 10
...
/obj/item/gun/ballistic/automatic/fallout/lsw
	...
	fire_sound = 'mojave/sound/f13weapons/assaultrifle_fire.ogg'
	can_suppress = FALSE
	fire_delay = 0.3
	w_class = WEIGHT_CLASS_HUGE
	weapon_weight = WEAPON_HEAVY */
