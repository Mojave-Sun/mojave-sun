...
//Ash Flora Type Plants but FALLOUT FORAGE EDITION

/obj/structure/flora/fallout/forage
	gender = PLURAL
	...
	var/harvest = /obj/item/reagent_containers/food/snacks/grown/fallout/tarberry
...
/obj/structure/flora/fallout/forage/Initialize()
	. = ..()
...
/obj/structure/flora/fallout/forage/proc/harvest(user)
	if(harvested)
		return 0
...
/obj/structure/flora/fallout/forage/proc/regrow()
	icon_state = base_icon
	name = initial(name)
	desc = initial(desc)
	harvested = FALSE

/obj/structure/flora/fallout/forage/attackby(obj/item/W, mob/user, params)
...
/obj/structure/flora/fallout/forage/attack_hand(mob/user)
	. = ..()
	if(.)
		return
...
/obj/structure/flora/fallout/forage/blackberry
	...
	harvest = /obj/item/reagent_containers/food/snacks/grown/fallout/blackberry

/obj/structure/flora/fallout/forage/mutfruit
	icon_state = "mutfruit"
	name = "mutfruit plant"
	...
	harvest = /obj/item/reagent_containers/food/snacks/grown/fallout/mutfruit
...
/obj/structure/flora/fallout/forage/ashrose
	icon_state = "ashrose"
	...
	harvest = /obj/item/reagent_containers/food/snacks/grown/fallout/ashrose
...
/obj/structure/flora/fallout/forage/wildcarrot
	icon_state = "root"
	...
	harvest = /obj/item/reagent_containers/food/snacks/grown/fallout/carrot
...
/obj/structure/flora/fallout/forage/aster
	icon_state = "aster"
	name = "aster flowers"
	...
	harvest = /obj/item/reagent_containers/food/snacks/grown/fallout/aster
...
/obj/structure/flora/fallout/forage/mushroom
	...
	harvest = /obj/item/reagent_containers/food/snacks/grown/fallout/cavefungus
...
/obj/structure/flora/fallout/forage/mushroom/glowing
	color =  "#98b752"
	...
	harvest = /obj/item/reagent_containers/food/snacks/grown/fallout/glowfungus
	light_range = 1.5
	light_power = 2.1
	light_color = "#3eff3e"
...
/obj/structure/flora/fallout/tree
	name = "tree"
	desc = "A large tree."
	density = TRUE
	pixel_x = -16
...
/obj/structure/flora/fallout/tree/attackby(obj/item/W, mob/user, params)
	if(log_amount && (!(flags_1 & NODECONSTRUCT_1)))
		if(W.sharpness == IS_SHARP_AXE)
			if(W.hitsound)
				playsound(get_turf(src), 'mojave/sound/f13effects/wood_cutting.ogg', 100, FALSE, FALSE)
...
/obj/structure/flora/fallout/tree/deadsnow
	name = "dead tree"
...
/obj/structure/flora/fallout/tree/deadsnow/New()
	icon_state = "snowtree_[rand(1,3)]"
	..()

/obj/structure/flora/fallout/tree/pine
	name = "pine tree"
...
/obj/structure/flora/fallout/tree/pine/New()
	icon_state = "pine_[rand(1,2)]"
	..()

/obj/structure/flora/fallout/tree/tallpine
	name = "pine tree"
...
/obj/structure/flora/fallout/tree/tallpine/New()
	icon_state = "pine_[rand(1,3)]"
	..()

/obj/structure/flora/fallout/tree/wasteland
	name = "dead tree"
	desc = "It's a tree. Useful for combustion and/or construction."
	icon = 'mojave/icons/flora/trees.dmi'
...
/obj/structure/flora/fallout/tree/wasteland/New()
	icon_state = "deadtree_[rand(1,6)]"
	..()

/obj/structure/flora/fallout/tree/joshua
	name = "joshua tree"
...
/obj/structure/flora/fallout/tree/cactus
	name = "cactus"
