...
/turf/open/transparent/openspace/update_multiz(prune_on_fail = FALSE, init = FALSE)
	. = ..()
	var/turf/T = below()
...
// /turf/open/transparent/openspace/multiz_turf_del(turf/T, dir)
// 	if(dir != DOWN)
// 		return
// 	update_multiz()

// /turf/open/transparent/openspace/multiz_turf_new(turf/T, dir)
// 	if(dir != DOWN)
// 		return
// 	update_multiz()
